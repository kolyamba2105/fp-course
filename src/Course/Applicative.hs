...
instance Applicative List where
  ...
  (<*>) _ Nil                 = Nil
  (<*>) Nil _                 = Nil
  (<*>) (fn :. fns) (a :. as) = fn a :. (pure fn <*> as) ++ (fns <*> (a :. as))
...
lift3 fn ka kb kc = lift2 fn ka kb <*> kc
...
lift4 fn ka kb kc kd = lift3 fn ka kb kc <*> kd
...
filtering p = foldRight (\el r -> lift2 (\a b -> if b then el :. a else a) r (p el)) (pure Nil)
